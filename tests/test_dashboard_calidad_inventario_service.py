...
def test_export_dashboard_calidad_inventario_csv_uses_findings(monkeypatch):
    ...
    assert "regla,access_id,estado_base,path_atc,cto,operador,severidad" in csv_text
    assert "Sin match en OLT,123,IN SERVICE,TG01-RATC-0-0001,TG01-FATC-1-0001,1001,alta" in csv_text
